          ...
          <!-- Error Messages -->
				...
				<form class="form-group" action="" method="post" novalidate="">
					<div class="form-group">
						...
						<input type="text" name="name" id="fullname" placeholder="Full Name" required pattern="[A-Za-z/\s]+" title="Only lower and upper case and space" class="form-control" value="
